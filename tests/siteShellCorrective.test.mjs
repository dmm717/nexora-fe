...
test('About numbering follows the visible sections for every optional combination', () => {
  for (const [content, ids] of [
    [base, ['mission', 'values', 'ecosystem']],
    [{ ...base, milestones: [{ label: '2026', title: 'Launch', description: '' }] }, ['mission', 'values', 'milestones', 'ecosystem']],
    [{ ...base, teamSectionEnabled: true, teamMembers: [{ name: 'A', role: 'B' }] }, ['mission', 'values', 'team', 'ecosystem']],
    [{ ...base, milestones: [{ label: '2026' }], teamSectionEnabled: true, teamMembers: [{ name: 'A' }] }, ['mission', 'values', 'milestones', 'team', 'ecosystem']],
  ]) {
...
test('About table of contents and section eyebrows consume the same number model', async () => {
  ...
  for (const id of ['mission', 'values', 'milestones', 'team', 'ecosystem'])
